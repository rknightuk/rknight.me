...
export function getSdk(requester) {
  return {
    link(variables, options) {
      return requester(LinkDocument, variables, options);
    },
    linkConnection(variables, options) {
      return requester(LinkConnectionDocument, variables, options);
    },
