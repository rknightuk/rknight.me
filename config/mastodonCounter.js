// https://github.com/mastodon/mastodon/blob/5d5c0f4f4358f4349d9e2db59cf90b1f5de24e81/app/javascript/mastodon/features/compose/util/url_regex.js
const regexen = {}
...
const urlRegex = () => {
	...
	regexen.validCCTLD = regexSupplant(
		RegExp(
			'(?:(?:' +
	...
	regexen.validDomain = regexSupplant(
	...
	regexen.validUrlPathEndingChars = regexSupplant(
		/[^#{spaces_group}\(\)\?!\*';:=\,\.\$%\[\]#{pd}~&\|@]|(?:#{validUrlBalancedParens})/i,
	)
